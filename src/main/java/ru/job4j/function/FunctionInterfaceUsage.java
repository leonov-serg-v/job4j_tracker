...
public class FunctionInterfaceUsage {
    public static void main(String[] args) {
        ...
        Supplier<Set<String>> supList = () -> new HashSet<>(list);
        Set<String> strings = supList.get();
        ...
        consumerBi.accept(sup2.get(), " and Second String");
        BiConsumer<Integer, String> consumerBi2 = (i, s1) -> System.out.println(i + s1);
        int ii = 1;
        for (String s : strings) {
            consumerBi2.accept(ii++, " is " + s);
        }
        ...
        BiFunction<String, Integer, Character> biFuncChar = (s, ind) -> s.charAt(ind);
        System.out.println("Третий символ в строке: " + biFuncChar.apply("first", 2));
        System.out.println("Третий символ в строке: " + biFuncChar.apply("second", 2));

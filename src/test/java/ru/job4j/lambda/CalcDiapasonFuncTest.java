...
public class CalcDiapasonFuncTest {
    @Test
    public void whenLinearFunctionThenLinearResults() {
        List<Double> result = CalcDiapasonFunc.diapason(5, 8, x -> 2 * x + 1);
    ...
    public void whenQuadraticFunctionThenQuadraticResults() {
        List<Double> result = CalcDiapasonFunc.diapason(5, 8, x -> Math.pow(x, 2));
